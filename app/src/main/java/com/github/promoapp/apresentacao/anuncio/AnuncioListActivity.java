...
import com.github.promoapp.apresentacao.anuncio.dummy.DummyContent;

import java.util.List;

/**
 * An activity representing a list of Anuncios. This activity
 * has different presentations for handset and tablet-size devices. On
 * handsets, the activity presents a list of items, which when touched,
 * lead to a {@link AnuncioDetailActivity} representing
        ...
        private final View.OnClickListener mOnClickListener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mTwoPane) {
                    ...
                    arguments.putString(AnuncioDetailFragment.ARG_ITEM_ID, item.id);
                    ...
                    intent.putExtra(AnuncioDetailFragment.ARG_ITEM_ID, item.id);
